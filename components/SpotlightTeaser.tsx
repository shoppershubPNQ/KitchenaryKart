  ...
  return (
    <section className="max-w-site mx-auto px-[6mm] md:px-[1.5cm]">
      {/* Section title — matches the site's centered brand section headings
          (cf. Watch & Shop) with decorative flanking lines + a small kicker,
          all in brand red for a cohesive, attention-drawing feel. */}
      <div className="text-center mb-8 md:mb-10">
        <div className="flex items-center justify-center gap-3 md:gap-4">
          ...
          <h2 className="flex items-center gap-2 font-head font-bold text-brand text-[clamp(1.6rem,2.4vw,2.2rem)] leading-none whitespace-nowrap">
            <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5 md:h-6 md:w-6 text-brand shrink-0" aria-hidden>
        ...
        <p className="mt-2.5 text-[11px] md:text-xs font-semibold uppercase tracking-[3px] text-brand">
          Handpicked for you
        </p>
      </div>
