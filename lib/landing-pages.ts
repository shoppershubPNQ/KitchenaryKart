...
export const LANDING_PAGES: LandingPage[] = [
  {
    ...
    metaDescription:
      'Commercial kitchen equipment supplier in India — 2,000+ HORECA products with GST invoice, direct brand pricing and free pan-India delivery above ₹5,000.',
    intro: [
    ...
    faqs: [
      {
        ...
        a: 'Yes. We are based in Pune and deliver pan-India to restaurants, hotels, cafés, cloud kitchens, bakeries and caterers, with free delivery on orders above ₹5,000.',
      },
      {
  ...
  },
  {
    ...
    metaDescription:
      'Hotel kitchen equipment supplier in India — banquet, buffet & production gear. GST invoice, bulk pricing and free pan-India delivery above ₹5,000.',
    intro: [
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'We deliver pan-India, including Mumbai, Bangalore, Hyderabad, Delhi and tier-2 cities, with free delivery above ₹5,000.',
      },
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Most orders dispatch within 1–3 business days with pan-India delivery, free above ₹5,000.',
      },
    ],
  ...
  },
  {
    ...
    metaDescription:
      'Bakery equipment supplier in India — dough sheeters, planetary mixers & baking tools. GST invoice, direct pricing & free pan-India delivery above ₹5,000.',
    intro: [
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'We deliver pan-India, free on orders above ₹5,000.',
      },
    ],
  ...
  },
  {
    ...
    metaDescription:
      'HORECA equipment supplier in India for hotels, restaurants & catering. 2,000+ products, GST invoice, bulk pricing & free pan-India delivery above ₹5,000.',
    intro: [
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Yes — we deliver pan-India with free delivery above ₹5,000, and offer bulk pricing for multi-unit and chain operations.',
      },
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Yes — we serve Pune businesses directly and deliver across the city, with free delivery on orders above ₹5,000. We also ship pan-India.',
      },
      {
